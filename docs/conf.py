...
htmlhelp_basename = 'F5DNSAutomationDemo121xdoc'
...
man_pages = [
    (master_doc, 'f5dnsautomationdemo121x', u'F5 DNS Automation Demo 12.1.x Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'F5DNSAutomationDemo121x', u'F5 DNS Automation Demo 12.1.x Documentation',
     author, 'F5DNSAutomationDemo121x', 'One line description of project.',
     'Miscellaneous'),
]
